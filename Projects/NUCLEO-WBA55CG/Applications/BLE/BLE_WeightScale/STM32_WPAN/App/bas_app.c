...
void BAS_Notification(BAS_NotificationEvt_t *p_Notification)
{
  ...
  switch(p_Notification->EvtOpcode)
  {
    ...
    case BAS_BAL_NOTIFY_ENABLED_EVT:
      /* USER CODE BEGIN Service4Char1_NOTIFY_ENABLED_EVT */
      ...
      /* USER CODE END Service4Char1_NOTIFY_ENABLED_EVT */
      break;

    case BAS_BAL_NOTIFY_DISABLED_EVT:
      /* USER CODE BEGIN Service4Char1_NOTIFY_DISABLED_EVT */
      UTIL_TIMER_Stop(&(BAS_APP_Context.TimerLevel_Id));
      /* USER CODE END Service4Char1_NOTIFY_DISABLED_EVT */
      break;
...
__USED void BAS_Bal_SendNotification(void) /* Property Notification */
{
  ...
  /* USER CODE BEGIN Service4Char1_NS_1*/

  /* USER CODE END Service4Char1_NS_1*/
  ...
  /* USER CODE BEGIN Service4Char1_NS_Last*/

  /* USER CODE END Service4Char1_NS_Last*/
