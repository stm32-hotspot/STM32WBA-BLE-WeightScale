        ...
        case ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE:
        {
          ...
          if(p_attribute_modified->Attr_Handle == (BAS_Context.BalCharHdle + CHARACTERISTIC_DESCRIPTOR_ATTRIBUTE_OFFSET))
          {
            ...
            switch(p_attribute_modified->Attr_Data[0])
            {
              ...
              case COMSVC_Notification:
                /* USER CODE BEGIN Service4_Char_1_COMSVC_Notification_BEGIN */

                /* USER CODE END Service4_Char_1_COMSVC_Notification_BEGIN */
                notification.EvtOpcode = BAS_BAL_NOTIFY_ENABLED_EVT;
                BAS_Notification(&notification);
                /* USER CODE BEGIN Service4_Char_1_COMSVC_Notification_END */

                /* USER CODE END Service4_Char_1_COMSVC_Notification_END */
                break;
