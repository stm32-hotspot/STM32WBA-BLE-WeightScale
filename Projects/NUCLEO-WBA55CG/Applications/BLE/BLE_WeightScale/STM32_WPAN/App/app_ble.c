...
BCS_APP_ConnHandleNotEvt_t BCSHandleNotification;
BAS_APP_ConnHandleNotEvt_t BASHandleNotification;
CTS_APP_ConnHandleNotEvt_t CTSHandleNotification;

static const char a_GapDeviceName[] = {  'W', 'e', 'i', 'g', 'h', 't', ' ', 'S', 'c', 'a', 'l', 'e' }; /* Gap Device Name */

/* Advertising Data */
uint8_t a_AdvData[28] =
{
  6, AD_TYPE_COMPLETE_LOCAL_NAME, 'W', 'S', '_', 'X', 'X',  /* Complete name */
  3, AD_TYPE_APPEARANCE, 0x00, 0x00 /* UNKNOWN_APPEARANCE */,
  3, AD_TYPE_16_BIT_SERV_UUID_CMPLT_LIST, 0x1D, 0x18,
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      BCSHandleNotification.EvtOpcode = BCS_DISCON_HANDLE_EVT;
      ...
      BCSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      ...
      BCS_APP_EvtRx(&BCSHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          BCSHandleNotification.EvtOpcode = BCS_CONN_HANDLE_EVT;
          ...
          BCSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          BCSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
    {
      ...
      switch (p_blecore_evt->ecode)
      {
        ...
        case ACI_GAP_PAIRING_COMPLETE_VSEVT_CODE:
        {
          ...
          if (p_pairing_complete->Status != 0)
          {
            WSSHandleNotification.PairingComplete = FALSE;
            BCSHandleNotification.PairingComplete = FALSE;
          }
          else
          {
            WSSHandleNotification.PairingComplete = TRUE;
            BCSHandleNotification.PairingComplete = TRUE;
          }
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_WEIGHT_SCALE; /* FW ID */
...
{
  WSSHandleNotification.EvtOpcode = WSS_FORCE_MEAS_EVT;
  BCSHandleNotification.EvtOpcode = BCS_FORCE_MEAS_EVT;
  WSS_APP_EvtRx(&WSSHandleNotification);
  BCS_APP_EvtRx(&BCSHandleNotification);
  return;
}
